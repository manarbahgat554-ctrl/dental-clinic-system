        ...
        <div className="flex h-16 items-center justify-between border-b px-5">
          <NavLink to="/app/dashboard" className="flex items-center gap-2.5">
            ...
            <div className="leading-tight">
              <div className="font-display text-base font-bold tracking-tight">{t('common.appName')}</div>
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        ...
                        <span>{t(`nav.${item.label.toLowerCase().replace(/\s/g, '')}`)}</span>
                      </>
                    )}
                  </NavLink>
                ))}
        ...
        <div className="border-t p-3">
          <div className="flex items-center gap-3 rounded-lg p-2">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-sm font-medium">{profile?.fullName ?? 'Guest'}</p>
              {profile && (
                <span
                  className={cn(
