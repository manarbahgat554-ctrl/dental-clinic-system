...
export function AuthLayout({ children, title, subtitle, footer }: AuthLayoutProps) {
  ...
  const features = [
    { icon: Stethoscope, label: t('auth.feature1') },
    { icon: Activity, label: t('auth.feature2') },
    { icon: CalendarHeart, label: t('auth.feature3') },
    { icon: ShieldCheck, label: t('auth.feature4') },
  ];
